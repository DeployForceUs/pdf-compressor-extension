...
const outDir = resolve(root, ".tmp-ai-runtime-zip");
...
try {
  execFileSync(process.execPath, [
    ...
    "tests/phase17_ai_runtime_zip_completion.test.ts",
  ], { cwd: root, stdio: "inherit" });

  execFileSync(process.execPath, [
    "--test",
    resolve(outDir, "tests/phase17_ai_runtime_zip_completion.test.js"),
  ], { cwd: root, stdio: "inherit" });
} finally {
  rmSync(outDir, { recursive: true, force: true });
}
