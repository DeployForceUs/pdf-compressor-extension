...
const outDir = resolve(root, ".tmp-ai-runtime-split");
...
try {
  execFileSync(process.execPath, [
    ...
    "tests/phase16_ai_runtime_split_dispatch.test.ts",
  ], { cwd: root, stdio: "inherit" });

  execFileSync(process.execPath, [
    "--test",
    resolve(outDir, "tests/phase16_ai_runtime_split_dispatch.test.js"),
  ], { cwd: root, stdio: "inherit" });
} finally {
  rmSync(outDir, { recursive: true, force: true });
}
