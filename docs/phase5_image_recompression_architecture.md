...
- no PDF objects are mutated yet
- no image decode, recompress, or stream replacement has been added yet
...
The next step is image recompression planning for the safe candidates only.
