...
- Stage 7: **Implemented on `feature/phase7-freemium-licensing` and awaiting final browser acceptance/merge**; the approved MVP uses offline ES256 perpetual tokens, local Free counters, persisted quality, and device-aware size limits.
